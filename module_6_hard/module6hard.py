...
class Figure:
    ...
    def __init__(self, __color, __sides):
        self.__color = [color for color in __color]
        # self.__sides = [__sides]
        self.__sides = []
        for _ in range(self.sides_count):
            self.__sides.append(__sides)
        self.filled = True 
    ...
    def __is_valid_sides(self, *sides):
        #### Debugging ####
        # print(f"Len: {len(sides)}")
        # print(f"Side_count:{self.sides_count}")
        # print(sides)
        # print(self.sides_count == len(sides))
        # print(f"Bool/len:{len(sides) == 12}")
        ###################
...
class Triangle(Figure):
    ...
    def get_square(self):
        ...
        s = (
            p
            * (p - self._Figure__sides[0])
            * (p - self._Figure__sides[1])
            * (p - self._Figure__sides[2])
        )
...
circle1 = Circle((200, 200, 100), 10)  # (Цвет, стороны)
cube1 = Cube((222, 35, 130), 6)
triangle1 = Triangle((200, 131, 100), 5)
...
cube1.set_color(300, 70, 15)  # Не изменится
print(cube1.get_color())
triangle1.set_color(255, 70, 15)  # Изменится
...
circle1.set_sides(15)  # Изменится
print(circle1.get_sides())
triangle1.set_sides(15, 15, 15)  # Изменится
print(triangle1.get_sides())

# Проверка периметра (круга), это и есть длина:
print(len(circle1))  # 15
print(len(triangle1))  # 45

# Area:
print(round(triangle1.get_square(), 2))
print(round((circle1.get_square()), 2))
