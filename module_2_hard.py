...
# Примечания:
# Можно использовать как цикл for, так и цикл while Первое число не входит в одно из чисел пары
# Пары чисел подбираются от 1 до 20 для текущего числа.

n = int(input("Type your number: "))
if n < 3 or n > 20:
    raise ValueError("Invalid input: n must be more than 3 and less than 20")
...
def password(n):
    ...
    password = passwords.get(n)
    return password


pair_list = list(range(1, n))
result = ""
